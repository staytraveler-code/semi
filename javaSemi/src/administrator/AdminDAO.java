...
public class AdminDAO {
	...
	// 기관 전체 출력리스트
	public List<OrganizationDTO> ListOrgan(){
	...
	// 1. 이름으로 기관 검색
	public List<OrganizationDTO> findByOrganName(String key){
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		List<OrganizationDTO> list = new ArrayList<>();
	...
	// 2. 기관타입으로 기관 검색
		public List<OrganizationDTO> findByOrganType(String key){
			PreparedStatement pstmt = null;
			ResultSet rs = null;
			List<OrganizationDTO> list = new ArrayList<>();
	...
	// 3. 주소지로 기관 검색
		public List<OrganizationDTO> findByOrganAddr(String key){
			PreparedStatement pstmt = null;
			ResultSet rs = null;
			List<OrganizationDTO> list = new ArrayList<>();
	...
	// 1. 과제 주제별
		public List<ProjectDTO> FindByProjectTitle(String key){
			PreparedStatement pstmt = null;
			ResultSet rs = null;
			List<ProjectDTO> list = new ArrayList<>();
	...
	// 2. 과제 단계별로 검색(1~4단계
		public List<ProjectDTO> FindByProjectStage(String key){
			PreparedStatement pstmt = null;
			ResultSet rs = null;
			List<ProjectDTO> list = new ArrayList<>();
	...
	// 3. 과제 상태별로 검색(진행중 완료 지연 등
		public List<ProjectDTO> FindByProjectStatus(String key){
			PreparedStatement pstmt = null;
			ResultSet rs = null;
			List<ProjectDTO> list = new ArrayList<>();
	...
	// 4. 과제 예산 내림차순
		public List<ProjectDTO> ListProjectBudget(){
			PreparedStatement pstmt = null;
			ResultSet rs = null;
			List<ProjectDTO> list = new ArrayList<>();
