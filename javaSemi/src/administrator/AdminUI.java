...
public class AdminUI {
	...
	private OrganizationDTO odto = new OrganizationDTO();
	private ProjectDTO pdto = new ProjectDTO();
		...
		try {
			...
			if (list.isEmpty()) {
				...
				for (int i = 0; i < list.size(); i++) {
					...
					System.out.printf("%d. [%s] %s | %s | %s | %s | %s | %s | %s%n", i + 1, dto.getOrgCode(), dto.getOrgName(),
							dto.getOrgType(), dto.getBizRegNo(), dto.getOrgTel(),
							dto.getOrgEmail(), dto.getOrgAddress(), dto.getOrgId()
							);
				}
			}
			System.out.println("======================\n");
						...
						if (list.isEmpty()) {
							...
							for (int i = 0; i < list.size(); i++) {
								...
								System.out.printf("%d. [%s] %s | %s | %s | %s | %s | %s | %s%n", 
										i + 1, dto.getProjectCode(), dto.getOrgName(),
										dto.getTitle(), dto.getStage(), dto.getStatus(),
										dto.getBudget(), dto.getStartDate(), dto.getEndDate()
										);
							}
						}
						System.out.println("======================\n");
